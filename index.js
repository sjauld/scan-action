...
async function runScan({
  ...
  if (outputFormat.toLowerCase() === "") {
    ...
    if (
      ...
      throw new Error(
        `Invalid output-format is set to ${outputFormat} - please ensure you use json, table or cyclonedx`
      );
    }
  ...
  out.vulnerabilities = vulnerabiltiesPath;
